            ...
            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                <div class="footer-item">
                    ...
                    <ul class="contact-info">
                        <li>
                            Address: Darbar Galli Nandura
                        </li>
                        <li>
                            Email: <a href="">info@gauravbhavsar.com</a>
                                   <a style="margin-left:40px" href="">info@ommuhre.com</a>
                        </li>
                    
                        <li>
                            Phone: <a href="tel:+0477-85x6-552">8956210047</a> <br>
                                      <a style="margin-left:43px" href="tel:+0477-85x6-552">9423166190</a>
                        </li>
                    </ul>
            ...
            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                <div class="footer-item clearfix">
                    ...
                    <div class="Subscribe-box">
                        <p>The seller can submit the property what he wants to sale with a full house or flat detail such as location, area, 
                            hall, kitchen, furnished, semi furnished, price, and all amenities can list in the form, Buyer can search the property according to their budget, location then direct contact to the seller..</p>
