      ...
      <div class="card-body">
        <form method="post" enctype="multipart/form-data">
          ...
          <div class="form-group">
            <label for="Aaditya@123">Email address</label>
            <input class="form-control" id="Aaditya@123" name="email" aria-describedby="emailHelp" placeholder="Enter email">
          </div>
          ...
          <a href="dashboard.php"> <input class="btn btn-primary btn-block" type="submit" value="Login" name="save" />
          </a>
